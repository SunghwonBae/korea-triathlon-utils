...
export default function MainIndex() {
  ...
  const menuItems = [
    ...
    { icon: "🔍", title: "아이언맨 기록검색기", desc: "아이언맨 대회기록검색", url: "/ironman_records_search.html" },
    { icon: "🔍", title: "아이언맨 70.3 기록검색기", desc: "아이언맨 70.3 대회기록검색", url: "/ironman_70.3_records_search.html" },
