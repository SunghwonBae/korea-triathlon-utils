...
export default function MainIndex() {
  ...
  const menuItems = [
    ...
    { icon: "👑", title: "킹코스 기록_2019", desc: "2019년까지 킹완주 기록", url: "/report/report_old_king.html" },
    { icon: "👑", title: "킹코스 기록_new", desc: "2019년 이후도 추가된 킹완주 기록", url: "/report/report_all_king_new.html" },
