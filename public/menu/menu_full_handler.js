...
async function loadAndInitializeMenu() {
    try {
        const response = await fetch('/menu/menu_structure.html');
        ...
        <footer class="main-footer">
            ...
            <div class="donation-card">
              ...
              <div class="donation-btn-group">
                <a href="Supertoss://send?amount=0&bank=%EC%B9%B4%EC%B9%B4%EC%98%A4%EB%B1%85%ED%81%AC&accountNo=3333137635297&origin=qr" class="btn-toss" onclick="handleTossClick(event, '3333137635297')">
                    <img src="/img/Toss_Symbol_Primary.png" width="20" height="20" alt="Toss" class="btn-icon"/>
                    Toss 후원
                </a>
          ...
          <div id="tossModal" class="qr-modal-overlay" onclick="closeQrModal('tossModal')">
            <div class="qr-modal-content" onclick="event.stopPropagation()">
                ...
                <img src="/img/toss_qr.jpg" alt="Toss QR" class="qr-image" style="display:block; margin: 15px auto;">
            ...
            <div style="text-align: center; margin: 30px 0; padding: 0 10px;">
                <p style="margin-bottom: 10px; font-size: 0.9rem;">대회요강 URL : <a href="https://cafe.naver.com/swimbikerun/3944" target="_blank">https://cafe.naver.com/swimbikerun/3944</a></p>
                <p style="margin-bottom: 10px; font-size: 0.9rem;">참가신청 URL : <a href="https://form.naver.com/response/Qz6Btxvu03pWAu9vYPCfZA" target="_blank">https://form.naver.com/response/Qz6Btxvu03pWAu9vYPCfZA</a></p>
